...
#define EMAIL_DOMAIN "xyz.com"
#define token_delimiters " :@"
#define Command_length 1000
#define EMAIL_DOMAIN2 "abc.com"
...
int main(int argc,char *argv[])
{
    ...
    port_num3 = atoi(argv[2]);
    port_num1 = atoi(argv[3]);
    ...
    if(fork()==0)
    {
	    ...
	    rst = inet_pton(AF_INET, "10.117.11.131", &srv_addr.sin_addr); /* To
	                            * type conversion of the pointer here. */
	    if (rst <= 0)
	    {
		        ...
		        while(1)
		        {
		            ...
		            if(strcmp(buf,"1")==0) // Client msg bhejega
		            {
		                ...
		                if(strcmp(tokens[3],EMAIL_DOMAIN)==0)
		                {
		                    ...
		                    {
		                    	if(strcmp(tokens[3],"abc.com")!=0)
		                    	{
		                    		usleep(100000);
                                    printf("yaha aa gaya 512\n");
		                        ...
		                        memset(buf,'\0',sizeof(buf));
		                        rst = recv(cfd,buf,1000,0);  // subject
	     						strcpy(mailsubject,buf);

		 						memset(mailcontent,'\0',sizeof(mailcontent));
	                            memset(buf,'\0',sizeof(buf));
		                        rst = recv(cfd,buf,1000,0); // message
